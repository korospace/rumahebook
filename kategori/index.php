...
<body>
	...
	<!-- <conainer-main-content> -->
	<div class="position-relative container-fluid d-flex flex-column px-4 pb-5" style="padding: 60px 0 0 0;min-height:100vh;" id="containerMainContent">
		...
		<!-- container-card -->
		<div class="position-relative row mx-0 mt-3 pt-3 pb-3 px-2 rounded-lg d-flex align-items-start flex-wrap" id="container-card" style=" background: rgba( 255, 255, 255, 0.25 );box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37 );backdrop-filter: blur( 4px );-webkit-backdrop-filter: blur( 4px );flex: 1;">
